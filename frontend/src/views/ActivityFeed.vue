<template>
  <div class="activity">
    <header class="card header">
      <div>
        <h1>Aktivitäten</h1>
        <p class="muted">Feed für Team und Admins mit Status-Updates.</p>
      </div>
    ...
    <section v-if="!isTeam" class="card info">
      <h2>Kein Zugriff</h2>
      <p class="muted">Der Aktivitäts-Feed steht nur Team-Mitgliedern zur Verfügung.</p>
    </section>
    ...
    <section v-else class="card feed">
      ...
      <p v-if="!loading && !filteredEntries.length" class="muted empty">Keine Einträge vorhanden.</p>
    </section>
  </div>
</template>
