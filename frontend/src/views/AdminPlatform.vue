...
const adminTools = [
  ...
  },
  {
    ...
    category: "System",
    description: "Automatisch erkannte Plattformen, Versionen und Zugriffe zentral verwalten.",
    buttonLabel: "Öffnen",
    icon: "🌐",
    features: ["Erkennung", "Versionen", "Zugriffe"],
  },
  {
    key: "artist-view",
    title: "Artist View",
    category: "Preview",
    description: "Sieh die Contest-Plattform direkt aus Artist-Sicht, ohne die Admin-Steuerung im Weg.",
    buttonLabel: "Vorschau",
    icon: "🎭",
    features: ["Contest", "Preview", "Artist UX"],
  },
  {
    key: "analytics",
